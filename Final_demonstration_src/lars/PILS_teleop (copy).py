...
class KeyboardControlNode(Node):
    def __init__(self):
        ...
        self.STEER_UI_MIN = -15000.0
        self.STEER_UI_MAX =  15000.0
        ...
        self.THRUST_STEP = 500.0       # 위/아래 한번 누를 때 목표 추력 변화량
        ...
        self.MAX_DSTEER_UI_PER_TICK = 1000.0   # dt=0.1 -> 초당 300 UI
