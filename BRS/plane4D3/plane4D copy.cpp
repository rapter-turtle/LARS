...
int main(int argc, char *argv[])
{
	...
	beacls::FloatVec center{ (FLOAT_TYPE)0, (FLOAT_TYPE)0.5,  (FLOAT_TYPE)0, (FLOAT_TYPE)0 };
	beacls::FloatVec widths{ (FLOAT_TYPE)1, (FLOAT_TYPE)1,  (FLOAT_TYPE)3, (FLOAT_TYPE)3 };

	beacls::FloatVec mask_center1{ (FLOAT_TYPE)0.5, (FLOAT_TYPE)0,  (FLOAT_TYPE)0, (FLOAT_TYPE)0 };
	beacls::FloatVec mask_widths1{ (FLOAT_TYPE)1, (FLOAT_TYPE)1,  (FLOAT_TYPE)3, (FLOAT_TYPE)3 };

	beacls::FloatVec mask_center2{ (FLOAT_TYPE)1, (FLOAT_TYPE)0,  (FLOAT_TYPE)0, (FLOAT_TYPE)0 };
	beacls::FloatVec mask_widths2{ (FLOAT_TYPE)2, (FLOAT_TYPE)2,  (FLOAT_TYPE)50, (FLOAT_TYPE)50 };
