...
data = np.loadtxt("/home/kiyong/BEACLS/beacls/sources/samples/plane4D1_cradle/all_loop.csv", delimiter=",")  # Ensure the correct delimiter is used
...
z_coords = z_vals[neg_indices[:, 2]]  # Corrected to use z_vals instead of y_vals for the Z-axis
