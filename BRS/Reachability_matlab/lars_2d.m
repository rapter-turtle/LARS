...
data = shapeCylinder(g, 2, [ 0; 0], targetRadius);
data0 = data;
...
hamValue = -((-schemeData.V0+grid.xs{2} ).* deriv{1} ...
	     - schemeData.Kp * grid.xs{1} .* deriv{2} ...
	     + schemeData.Vd* abs(deriv{1}) ...
	     + schemeData.Wd * abs(deriv{2}));
