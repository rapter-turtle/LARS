...
private:
    ...
    void run()
    {
        ...
        // if (lars_mode_ == 0){
        //     psi_d = uvr_filter::wrapToPi(pi_h - beta - std::atan2(y_ep, Delta) - yaw_);
        // }
        // else{
        //     const double dock_dx = wpt_x - x_;
        //     const double dock_dy = wpt_y - y_;
        //     psi_d = uvr_filter::wrapToPi(std::atan2(dock_dy, dock_dx) - yaw_);
        // }
