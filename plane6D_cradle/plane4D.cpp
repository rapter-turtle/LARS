...
int main(int argc, char *argv[])
{
	...
	beacls::FloatVec mins{ (FLOAT_TYPE)-5, (FLOAT_TYPE)-5, (FLOAT_TYPE)-5, (FLOAT_TYPE)-5, (FLOAT_TYPE)-M_PI, (FLOAT_TYPE)-5};
	...
	beacls::FloatVec left{ (FLOAT_TYPE)-1, (FLOAT_TYPE)-1.5,  (FLOAT_TYPE)-5, (FLOAT_TYPE)-5, (FLOAT_TYPE)-0.3*M_PI, (FLOAT_TYPE)-5 };
	beacls::FloatVec right{ (FLOAT_TYPE)1, (FLOAT_TYPE)1.5,  (FLOAT_TYPE)5, (FLOAT_TYPE)5, (FLOAT_TYPE)0.3*M_PI, (FLOAT_TYPE)+5};

	beacls::FloatVec mask_left1{ (FLOAT_TYPE)-1, (FLOAT_TYPE)-1.5,  (FLOAT_TYPE)-50, (FLOAT_TYPE)-50 , (FLOAT_TYPE)-0.4*M_PI, (FLOAT_TYPE)-5};
	beacls::FloatVec mask_right1{ (FLOAT_TYPE)1, (FLOAT_TYPE)1.5,  (FLOAT_TYPE)50, (FLOAT_TYPE)50, (FLOAT_TYPE)0.4*M_PI, (FLOAT_TYPE)+5};	

	beacls::FloatVec mask_left2{ (FLOAT_TYPE)-1, (FLOAT_TYPE)-5,  (FLOAT_TYPE)-100, (FLOAT_TYPE)-100, (FLOAT_TYPE)-M_PI, (FLOAT_TYPE)-5 };
	beacls::FloatVec mask_right2{ (FLOAT_TYPE)2, (FLOAT_TYPE)5,  (FLOAT_TYPE)100, (FLOAT_TYPE)100, (FLOAT_TYPE)M_PI, (FLOAT_TYPE)+5};	
