...
int main(int argc, char *argv[])
{
	...
	beacls::FloatVec mins{ (FLOAT_TYPE)-10, (FLOAT_TYPE)-6, (FLOAT_TYPE)-M_PI, (FLOAT_TYPE)-2.0};
	beacls::FloatVec maxs{ (FLOAT_TYPE)+2,(FLOAT_TYPE)+6,(FLOAT_TYPE)+M_PI,(FLOAT_TYPE)+2.0 };
	...
	beacls::FloatVec left{ (FLOAT_TYPE)-1, (FLOAT_TYPE)-1.5,  (FLOAT_TYPE)-0.3*M_PI, (FLOAT_TYPE)-0.5 };
	beacls::FloatVec right{ (FLOAT_TYPE)1, (FLOAT_TYPE)1.5,  (FLOAT_TYPE)0.3*M_PI, (FLOAT_TYPE)0.5};

	beacls::FloatVec mask_left1{ (FLOAT_TYPE)-1, (FLOAT_TYPE)-1.5,  (FLOAT_TYPE)-M_PI, (FLOAT_TYPE)-0.7 };
	beacls::FloatVec mask_right1{ (FLOAT_TYPE)1, (FLOAT_TYPE)1.5,  (FLOAT_TYPE)M_PI, (FLOAT_TYPE)0.7};	

	beacls::FloatVec mask_left2{ (FLOAT_TYPE)-1, (FLOAT_TYPE)-4,  (FLOAT_TYPE)-M_PI, (FLOAT_TYPE)-2 };
	beacls::FloatVec mask_right2{ (FLOAT_TYPE)2, (FLOAT_TYPE)4,  (FLOAT_TYPE)M_PI, (FLOAT_TYPE)2};	
	...
	std::vector<levelset::BoundaryCondition*> boundaryConditions(4);
...
//	ApproximationAccuracy_Type accuracy = ApproximationAccuracy_high;
	...
	// 	data3[i] = std::max(data1[i], data2[i]); // signed distance 유지
	// }
