...
data = np.loadtxt("/home/kiyong/BEACLS/beacls/sources/samples/LARS_BRS_4D_speed/all_loop.csv", delimiter=",")  # Ensure the correct delimiter is used
...
data_4d = data.reshape((Nx, Nx, Nx, Nx)).transpose(3, 2, 1, 0)


# Step 2: Map grid indices to physical coordinates
mins = [-10, -6, -3.141592, -2.0]
maxs = [2, 6, 3.141592, 2.0]
